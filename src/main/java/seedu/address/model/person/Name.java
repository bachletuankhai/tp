...
public class Name {
    ...
    public static final String MESSAGE_CONSTRAINTS =
            "Names should only contain alphanumeric characters, spaces, dot, apostrophe and hyphen, and it should not" +
                    " be blank. Please refer to the user guide for more detail on name validation.";
